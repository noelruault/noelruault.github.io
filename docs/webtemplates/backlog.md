...
- [ ] `t60-gallery` [d3]: `templates/index.html` gallery page, own design (not copied from any reference), one preview card per template linking into it, added to manifest and gated. Acceptance: gate green including the gallery.
