...
- t20-posthog 6ee0d79 — clean-room posthog.com deep-copy: Burrow desktop-OS metaphor (menubar, icon columns, closable window, inner scroll), auto-tabs, tools marquee, logo board swap, pricing table, retro-box CTA, 2 toasts; config-driven, own SVG moles, shingle scan zero; gate green 3 widths.
- t30-cipher-tv 22b0d88 — clean-room cipher.tv deep-copy: Cadence brand, CSS-trig tile ring with wheel rotation + parallax, hover grayscale/cursor label/workbar, work overlay, artists carousel, mirrored-text studio, dithered contact blob; config-driven, shingle scan 0, gate green 3 widths.
- t40-michaelgatt 61c6b15 — clean-room michaelgatt.com deep-copy: Emrys Vale composer universe, CSS-3D wheel-travel tile field replacing the Three.js canvas, intro word cascade with silent enter, deep-state chrome swap, trailing cursor label, index/about/contact overlays, scroll-spy rail + clip-wipe, own WebAudio drone; config-driven, shingle scan 0, gate green 3 widths.
