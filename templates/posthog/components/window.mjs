...
export default (config) => {
  ...
  return `<main class="ph-window absolute inset-x-2 bottom-0 top-[70px] z-20 mx-auto max-w-[1140px] overflow-hidden rounded-t-lg lg:inset-x-[150px]">
  <div class="absolute right-3 top-3 z-30 flex items-center gap-2.5 text-ph-sub">
    <button type="button" class="ph-win-max hidden lg:block" aria-label="${w.maximizeLabel}"><svg width="13" height="13" viewBox="0 0 13 13" fill="none" stroke="currentColor" stroke-width="1.4" aria-hidden="true"><rect x="1" y="1" width="11" height="11" rx="1.5"/></svg></button>
